...
urlpatterns = [
    ...
    path("khalti-payment/<uuid:order_id>/", KhaltiPaymentView.as_view(), name="khalti_payment"),
    path("khalti-payment/verify/", KhaltiPaymentVerifyView.as_view(), name="khalti_payment_verify"),
]
